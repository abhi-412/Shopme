                                ...
                                <h2 className=" text-sm  w-full p-1  ml-5 text-gray-500">Shipping Details</h2>
                                    ...
                                    <div className='p-3 flex gap-3'>
                                        ...
                                        <div className='text-sm flex gap-1 flex-col'>
                                            <p className="text-gray-600 flex gap-2 items-center">
                                                <span className='text-sm text-black'>{customer?.firstName?.toUpperCase().slice(0,1) + customer?.firstName?.slice(1).toLowerCase() + " " + customer?.lastName?.toUpperCase().slice(0,1) + customer?.lastName?.slice(1).toLowerCase()}</span>
                                            </p>
                                            <span>{address[0]?.addressLine1 + ", " +  address[0]?.addressLine2 }</span>
                                            <span> {address[0]?.city + ", " + address[0]?.state + ", " + address[0]?.pincode}</span>
                                            <span>{customer?.mobile}</span>
