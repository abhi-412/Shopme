    ...
    <>
      <Meta title={"Wishlist"} />
        ...
        <div className="grid md:grid-cols-4 grid-cols-2 gap-3">
                  ...
                  {wishlist?.map((item)=>(
                       <div className="col-span-1 bg-white shadow p-3 rounded">
                       <div className="w-full flex flex-col gap-4 relative">
                       <h6 className='text-sm  text-indigo-500 font-semibold'>{item?.category}</h6>
                           ...
                           <h6 className="price mb-3">Rs. {item?.price}/-</h6>
                             </div>
                       </div>
                   </div>
