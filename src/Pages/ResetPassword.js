...
const navigate = useNavigate();
  ...
  return (
    <>
      ...
      <Container class1="w-full min-h-96 flex justify-center items-center">
       
            <div className="flex justify-center items-center w-full ">
                <div className="w-[450px] p-6 rounded-md bg-white shadow">
                  <h3 className='text-center mb-3 font-semibold text-xl'>Reset Your Password</h3>
                  <form className='flex flex-col' onSubmit={formik.handleSubmit}>
                    ...
                    <div className="d-flex mt-3 justify-content-center gap-4 align-items-center">
                      <button type='submit' className='reset-button bg-orange-700 text-white py-2 px-4 rounded-full'>
                        Reset Password
                      </button>
                    </div>
                  </form>
